...
%	论文的中英文题目
% ===================
  ctitle = {\texorpdfstring{\ce{C60}}{C60}表面的纳米形貌的可控性转变\texorpdfstring{\\}{}兼论\LaTeX{}在论文排版中的运用},
  etitle = {To Use \LaTeX{} in the Typeseting of\texorpdfstring{\\}{}Graduating Work for CQU},
% ===================
% 作者部分的信息
